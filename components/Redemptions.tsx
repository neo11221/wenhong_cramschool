          ...
          {redemptions.map(r => (
            ...
            >
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-bold text-slate-800 text-lg">{r.productName}</h3>
                  <div className="flex items-center gap-3 text-xs text-slate-400 mt-1">
                    <span className="flex items-center gap-1"><Calendar size={12} /> {formatDate(r.timestamp)}</span>
                    <span className="font-bold text-indigo-600">-{r.pointsSpent} 點</span>
                  </div>
                </div>
              </div>
